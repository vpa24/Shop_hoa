            ...
            <div class="per-product clearfix">
              <div class="images-container">
                <div class="product-hover">
                  <a href="san-pham/{makeURL($giam_gia->TenHoa)}-{$giam_gia->MaHoa}.html" title="{$giam_gia->TenHoa}" class="product-image">
              ...
              <div class="products-textlink product-featured-custom clearfix">
                <h2 class="product-name">
                  <a href="san-pham/{makeURL($giam_gia->TenHoa)}-{$giam_gia->MaHoa}.html" title="{$giam_gia->TenHoa}">{$giam_gia->TenHoa}</a>
                </h2>
                <div class="price-box">
                  <p class="old-price">
              ...
              {number_format($giam_gia->Gia)}  đ</span>
                  ...
                  <a href="san-pham/{makeURL($giam_gia>TenHoa)}-{$giam_gia>MaHoa}.html" class="minimal-price-link">
